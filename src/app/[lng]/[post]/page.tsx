...
import { postsQuery, singlePostQuery } from '../../../sanity/lib/sanity.query';
import { PostType } from '@components/Blog/Types/table';
...
FeaturedPosts
CustomPortableText
const fallbackImage: string = "https://res.cloudinary.com/dlboynyri/image/upload/w_1000,ar_16:9,c_fill,g_auto,e_sharpen/v1734278923/fallbackImage_o7toik.webp"
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: `${post.title}`,
    metadataBase: new URL(`https://blog.emirongorur.com/${lng}/${post.slug}`),
    description: post.description,
    publisher: post.author.name,
    keywords: post.tags,
    alternates: {
      canonical:
        post.canonicalLink || `https://blog.emirongorur.com/${lng}/${post.slug}`,
    },
    openGraph: {
      images:coverImageUrl,
      url: `https://blog.emirongorur.com/${lng}/${post.slug}`,
      title: post.title,
      description: post.description,
      type: "article",
      siteName: "blog.emirongorur.com",
...
export default async function Post({ params }: Props) {
  ...
  return (  <main className="max-w-7xl mx-auto md:px-16 px-6">
    <header>
